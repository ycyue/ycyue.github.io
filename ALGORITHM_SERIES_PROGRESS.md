...
|---:|---|---|---:|---|---|---|
| Map | Python 基础算法学习地图 | 完整版 | 1 | N/A | 已完成 | 待更新发布 |
| 01 | 相向双指针（一） | 已完成 | 2 | 已通过 | 已完成 | 已上线验证 |
| 02–05 | 数组与基础算法思想 | 已完成 | 8 | 已通过 | 已完成 | 待发布 |
| 06–08 | 链表 | 已完成 | 6 | 已通过 | 已完成 | 待发布 |
| 09–13 | 二叉树 | 已完成 | 10 | 已通过 | 已完成 | 待发布 |
| 14–16 | 回溯 | 已完成 | 6 | 已通过 | 已完成 | 待发布 |
| 17–22 | 动态规划 | 已完成 | 12 | 已通过 | 已完成 | 待发布 |
| 23–25 | 树形 DP | 已完成 | 6 | 已通过 | 已完成 | 待发布 |
| 26–27 | 单调数据结构 | 已完成 | 4 | 已通过 | 已完成 | 待发布 |

## 下一步

1. 完成全量 SVG、内容结构、外链、移动端和深色模式检查。
2. 推送 `main`，等待博客构建与 GitHub Pages 部署成功。
3. 按模块抽查线上页面并将本表更新为“已上线验证”。
